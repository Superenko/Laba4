...
using System;
using labaa4.Simulation;
using labaa4.Simulation.GameType;
using labaa4.Service.Base;
using labaa4.Commands.Base;

namespace labaa4.Commands
{
    public class StartGame : BaseCommand
    {
        private BasePlayerService _playerService;
        private BaseGameService _gameService;
        private GameFactory _gameFactory;

        public StartGame(BasePlayerService playerService, BaseGameService gameService, GameFactory gameFactory)
        {
        ...
        public void Execute()
        {
            ...
            for (var i = 0; i < 1; i++)
            {
                ...
                var gameEntity = new GameEssence
                {
